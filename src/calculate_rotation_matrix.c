...
/*   Updated: 2024/04/06 13:29:58 by jorvarea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fdf.h"

void	calculate_x_rotation_matrix(t_rot_matrix *rot_matrix,
		float theta_x)
{
	rot_matrix->m[0][0] = 1;
	rot_matrix->m[0][1] = 0;
...
void	calculate_y_rotation_matrix(t_rot_matrix *rot_matrix,
		float theta_y)
{
...
void	calculate_z_rotation_matrix(t_rot_matrix *rot_matrix,
		float theta_z)
{
